...
var heroData=require("../data/main").heroData,HeroOption=require("./HeroOption"),heroOptionsArray={},init=function(){heroOptionsArray.items=[];for(var r in heroData)heroOptionsArray.items.push(new HeroOption(r.replace("npc_dota_hero_",""),heroData[r].displayname));return heroOptionsArray.items};heroOptionsArray.init=init,module.exports=heroOptionsArray;
...
var ItemInput=require("./ItemInput"),itemData=require("../data/main").itemData,itemBuffs=["assault","ancient_janggo","headdress","mekansm","pipe","ring_of_aquila","vladmir","ring_of_basilius","buckler","solar_crest"],itemBuffOptions={},init=function(){return itemBuffOptions.items=itemBuffs.map(function(t){return new ItemInput(t,itemData["item_"+t].displayname)}),itemBuffOptions.items};itemBuffOptions.init=init,module.exports=itemBuffOptions;
},{"../data/main":6,"./ItemInput":23}],25:[function(require,module,exports){
var ItemInput=require("./ItemInput"),itemData=require("../data/main").itemData,itemDebuffs=[{item:"assault",debuff:null},{item:"shivas_guard",debuff:null},{item:"desolator",debuff:null},{item:"medallion_of_courage",debuff:null},{item:"radiance",debuff:null},{item:"sheepstick",debuff:null},{item:"veil_of_discord",debuff:null},{item:"solar_crest",debuff:null},{item:"silver_edge",debuff:{id:"shadow_walk",name:"Shadow Walk"}},{item:"silver_edge",debuff:{id:"maim",name:"Lesser Maim"}}],itemDebuffOptions={},init=function(){return itemDebuffOptions.items=itemDebuffs.map(function(e){return new ItemInput(e.item,itemData["item_"+e.item].displayname,e.debuff)}),itemDebuffOptions.items};itemDebuffOptions.init=init,module.exports=itemDebuffOptions;
},{"../data/main":6,"./ItemInput":23}],26:[function(require,module,exports){
var validItems=require("./validItems"),ItemInput=require("./ItemInput"),itemData=require("../data/main").itemData,itemOptionsArray={},init=function(){itemOptionsArray.items=[];for(var t=0;t<validItems.length;t++)itemOptionsArray.items.push(new ItemInput(validItems[t],itemData["item_"+validItems[t]].displayname));return itemOptionsArray.items};itemOptionsArray.init=init,module.exports=itemOptionsArray;
...
"use strict";var core={};core.InventoryViewModel=require("./inventory/InventoryViewModel"),core.AbilityModel=require("./AbilityModel"),core.BuffViewModel=require("./BuffViewModel"),core.HeroModel=require("./hero/HeroModel"),core.CloneModel=require("./hero/CloneModel"),core.UnitModel=require("./hero/UnitModel"),core.IllusionModel=require("./hero/IllusionModel"),core.Data=require("./data/main"),core.Util=require("./util/main"),core.init=function(e,r,i,o){core.Data.init(e,r,i,function(){core.HeroOptions=require("./hero/heroOptionsArray").init(),core.BuffOptions=require("./buffs/buffOptionsArray").init(),core.DebuffOptions=require("./buffs/debuffOptionsArray").init(),core.ItemOptions=require("./inventory/itemOptionsArray").init(),core.ItemBuffOptions=require("./inventory/itemBuffOptions").init(),core.ItemDebuffOptions=require("./inventory/itemDebuffOptions").init(),o()})},module.exports=core;
